...
stringData:
  ...
  # Cloud: apunta al sidecar Cloud SQL Auth Proxy (localhost:5432 dentro del pod)
  DATABASE_URL: "postgresql+psycopg2://sauron:CHANGE_ME_DB_PASSWORD@127.0.0.1:5432/computer-vision"
